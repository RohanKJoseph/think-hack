      ...
      <AnimatePresence mode={animatePresenceMode} initial={animatePresenceInitial}>
        ...
        >
          {elements.map((wordObj, wordIndex, array) => {
            const totalCharsInAnimation = array.reduce((sum, word) => sum + word.characters.length, 0);
              ...
              <span key={wordIndex} className={cn('inline-flex', splitLevelClassName)}>
                {wordObj.characters.map((char, charIndex) => (
                  <motion.span
                    ...
                    transition={{
                      ...transition,
                      delay: getStaggerDelay(previousCharsCount + charIndex, totalCharsInAnimation)
                    }}
...
export default function App() {
  const rotatingAdjectives = ["coding", "fun!", "creative..", "innovative"];

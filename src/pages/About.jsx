const AboutSection = () => (
  <section id="about" className='h-screen bg-transparent flex flex-col items-center justify-center p-4'>
    <div className='text-center'>
      <h3 className='text-white text-4xl font-bold mb-8'>
        About Tink Hack 2.0
      </h3>
      <div className='max-w-2xl mx-auto bg-gray-200/15 backdrop-blur-sm rounded-lg p-6'>
